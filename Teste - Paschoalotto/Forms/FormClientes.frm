...
Begin VB.Form FormClientes 
   ...
   Begin VB.Frame Consulta 
      ...
      Top             =   60
      Width           =   10605
      Begin VB.CommandButton Bt_Delete 
         Caption         =   "Deletar"
         Height          =   585
         Left            =   6330
         Picture         =   "FormClientes.frx":0000
         TabIndex        =   25
         ToolTipText     =   "Deletar Cadastro"
         Top             =   210
         Width           =   735
      End
      ...
      Begin VB.CommandButton bt_Salva 
         ...
         TabIndex        =   3
         ToolTipText     =   "Clique para salvar os dados do cliente"
         Top             =   210
         Width           =   735
      End
      Begin VB.CommandButton bt_novo 
         ...
         Height          =   585
         Left            =   120
         Picture         =   "FormClientes.frx":6BB2
         TabIndex        =   1
         ToolTipText     =   "Clique para criar um novo cadastro."
         Top             =   210
         Width           =   735
      End
   End
...
Private Sub bt_Salva_Click()
    ...
    If validacadatro = True Then
        ...
        Else
            ...
            conexao.Execute comando
            MsgBox "Dados criados com Sucesso!", vbInformation
    ...
    Call BuscaDadosBasicos
End Sub
Private Sub Bt_Delete_Click()
    Dim comando As String
    
    comando = "Delete from Clientes where codigoCliente = " & Codigo & ";"
    Cursor.Open comando, conexao
    
    Call LimpaDados_Click
...
Private Function validacadatro() As Boolean
    ...
    If CPF_CNPJ = "" Then
        MsgBox "Insira um CPF/CNPJ!", vbInformation
        Exit Function
    End If
    
    If DataNascimento = "" Then
        MsgBox "Insira uma Data de Nascimento!", vbInformation
        Exit Function
    End If
...
Sub BuscaDadosBasicos()
    ...
    Else
        MsgBox "Nenhum dado foi localizado para o codigo: " & Codigo
        Exit Sub
    End If
...
Private Sub bt_exporta_Click()
    Dim fso As Object
    Set fso = CreateObject("Scripting.FileSystemObject")

    Dim file As Object
    Set file = fso.CreateTextFile("C:\Fontes\Teste - Paschoalotto\Exportacao\Clientes_ " & Format(Date, "dd-mm-yyyy") & ".csv", True)

    Cursor.Open "Select CodigoCliente,Nome,CPF_CNPJ,DataNascimento,Observacao from clientes;", conexao

    file.WriteLine "CodigoCliente,Nome,CPF_CNPJ,DataNascimento,Observacao"
    Do While Not Cursor.EOF
        file.WriteLine Cursor.Fields("CodigoCliente") & "," & Cursor.Fields("Nome") & "," & Cursor.Fields("CPF_CNPJ") & "," & Cursor.Fields("DataNascimento") & "," & Cursor.Fields("Observacao")
        Cursor.MoveNext
    Loop
